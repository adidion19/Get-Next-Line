...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/10 15:21:25 by adidion           #+#    #+#             */
/*   Updated: 2020/12/14 17:17:33 by adidion          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		get_next_line(int fd, char **line)
{
	...
	(!(buff = malloc(sizeof(char) * (BUFFER_SIZE + 1)))))
		return (ft_protect(buff, s[fd]));
	while (!ft_newline(s[fd]) && i != 0)
	{
